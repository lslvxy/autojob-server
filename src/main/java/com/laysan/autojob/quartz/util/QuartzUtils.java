package com.laysan.autojob.quartz.util;
...
public class QuartzUtils {
    ...
    public static void createScheduleJob(Scheduler scheduler, QuartzBean quartzBean) throws Exception {
        ...
        s.put("accountId", quartzBean.getAccountId());
        JobDetail jobDetail = JobBuilder.newJob(jobClass).withIdentity(quartzBean.getJobName()).usingJobData(s)
                .build();
        // 设置定时任务执行方式
